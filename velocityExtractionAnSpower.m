function [Gx, midiVel, error, errorPerNoteResult, refVelCompare] = velocityExtractionAnSpower(audioFilename, MIDIFilename, B, basicParameter)
...
Gx = updateGwithTempo(Gx, X, Bcopy, Xhat, basicParameter.beta, 0);
