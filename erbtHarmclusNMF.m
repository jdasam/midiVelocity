function [A U]= erbtHarmclusNMF(X, A, U, F,f,alen, basicParameter, uFixed, attackMatrix)
if nargin<9
    attackMatrix = false;
end
...
while ~gconverged,
    ...
    while ~lconverged,
        ...
        tempA = updateGwithTempoPartial(tempA, X, tempU, Y, basicParameter, attackMatrix);
