...
for i = 1:length(txtList)
    ...
    [errorAndOmittedNotes(1,i), errorAndOmittedNotes(2,i), errorAndOmittedNotes(3,i), errorAndOmittedNotes(4,i), errorAndOmittedNotes(5,i)] = calMidiSyncErrorAndDiff(txtFileName);
